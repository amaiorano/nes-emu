...
namespace {
    ...
    public:
        void Create(size_t width, size_t height, SDL_Renderer* renderer) {
            m_width             = width;
            m_height            = height;
            m_backbufferTexture = SDL_CreateTexture(
    ...
    private:
        ...
        void Unlock() { SDL_UnlockTexture(m_backbufferTexture); }
...
void Renderer::Create(size_t screenWidth, size_t screenHeight) {
    ...
    m_impl->m_window = SDL_CreateWindow("", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED,
