...
protected:
    ...
    virtual bool IsOpenImpl() const { return m_file != nullptr; }
    ...
    virtual bool SetPosImpl(size_t pos) { return fseek(m_file, pos, 0) == 0; }
...
protected:
    ...
    virtual bool IsOpenImpl() const { return m_curr != nullptr; }
